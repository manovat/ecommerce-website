...
@PSubCatID,@PGender,@PSizesID,@PDescription,@PProductDetails,@PMaterialCare,@FreeDelivery,
@30DayRet,@COD) 
...
select * from tblProducts
insert into tblProducts values('BESPOQE  Men Regular Fit Solid Casual Shirt',1899.00,799.00,1,2,3,1,1,'For the best fit, buy one size larger than your usual size.','For the best fit, buy one size larger than your usual size.','For the best fit, buy one size larger than your usual size.',1,1,1)
insert into tblProducts values('HIGHLANDER  Men Slim Fit Checkered Spread Collar Casual Shirt',1299.00,546.00,2,2,1,1,1,'Product Details    Pack of  1  Style Code  HLSH010263  Fit  Slim  Fabric  Cotton Blend  Sleeve  Full Sleeve  Pattern  Checkered  Reversible  No  Collar  Spread  Color  Green, Black  Fabric Care  Gentle Machine Wash  Suitable For  Western Wear  Hem  Curved','100% cotton','100% cotton',1,1,1)
insert into tblProducts values('FASHION DEPTH  Women Embroidered Rayon Straight Kurta  (Pink)',1699.00,649.00,3,3,4,1,2,'Product Details    Ideal For  Women  Length Type  Calf Length  Brand Color  Pink  Occasion  Casual  Pattern  Embroidered  Type  Straight  Fabric  Rayon  Neck  Round Neck','Product Details    Ideal For  Women  Length Type  Calf Length  Brand Color  Pink  Occasion  Casual  Pattern  Embroidered  Type  Straight  Fabric  Rayon  Neck  Round Neck','100% cotton',1,1,1)
insert into tblProducts values('Oomph!  Casual Butterfly Sleeve Floral Print Women Multicolor Top',1330.00,450.00,4,4,5,1,2,'Casual Butterfly Sleeve Floral Print Women Multicolor Top','Product Details    Neck  Round Neck  Sleeve Style  Butterfly Sleeve  Fit  Relaxed  Fabric  Poly Crepe  Type  Regular Top  Belt Included  No  Pattern  Floral Print  Color  Multicolor','100% cotton',1,1,1)

select * from tblProductImages
insert into tblProductImages values(5,1,'BESPOQE  Men Regular Fit Solid Casual Shirt01','.jpeg')
